...
const Location = () => {
  return (
    <div className="mt-20 h-[38rem]">
      <div className="absolute w-full left-0 bg-yuma-100 py-20 px-10 flex justify-center">
        <div className=" w-[1440px] z-96">
          <div className="bg-yuma-50 flex">
            <div className="w-1/2 flex flex-col gap-6 p-6 justify-center">
              ...
              <Button
                size="lg"
                radius="sm"
                className="bg-yuma-400 text-white text-sm w-1/3"
              >
